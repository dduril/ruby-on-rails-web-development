...
class LineAnalyzer
  ...
  def calculate_word_frequency(content)
    ...
    #puts 'Debugging: calling calculate_word_frequency'
    ...
    puts "Debugging: highest_wf_count: #{@highest_wf_count}"
    puts "Debugging: highest_wf_words: #{@highest_wf_words}"
...
class Solution
  ...
  def analyze_file
    ...
    #puts 'Debugging: calling analyze_file'
    count = 0
  ...
  def calculate_line_with_highest_frequency
    ...
    #puts 'Debugging: calling calculate_line_with_highest_frequency'
  ...
  def print_highest_word_frequency_across_lines
    ...
    #puts 'Debugging: calling print_highest_word_frequency_across_lines'
    puts 'The following words have the highest word frequency per line:'
    @highest_count_words_across_lines.each{ |w| puts "#{w.highest_wf_words} (appears in line #{w.line_number})" }
  end
end